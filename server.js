...
            parts: [
                {
                    text: `당신은 상식 퀴즈를 생성하는 전문가입니다. **절대 이전에 생성한 질문을 재사용하지 마세요.** "과학", "역사", "한글 맞춤법", "심리학", "코딩", "디지털 리터러시", "안전 및 건강 상식", "경제", "지리", "정치", "사회"의 11개 주제 중에서 서로 다른 주제로 5개의 독특하고 새로운 상식 퀴즈 질문을 생성하세요. 아래 JSON 형식에 정확히 맞추어 질문, choices(보기는 3개 이상), explanation(해설), 그리고 정답의 인덱스(0부터 시작)인 correctAnswerIndex를 포함해야 합니다. 다른 설명 없이 JSON 배열만을 반환해야 합니다. 응답은 JSON Markdown 형식으로 제공되어야 합니다. [REQUEST_ID: ${Date.now()}]`, 
                }
            ]
        }
    ],
